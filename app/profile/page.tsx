    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-gray-900 mb-4 text-balance">My Profile</h1>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto text-pretty">Manage your account information and preferences</p>
